...
# Code from https://github.com/axelroques/Eye_Movement_Classification/tree/master
...
class IDT:
    ...
    def plot(self):
        ...
        if self.fixations.any():
            ...
            # Plot eye trace
            axes[0].plot(self.t, self.x, c='black', alpha=0.9)
            axes[0].set_ylabel('x', fontsize=15)

            axes[1].plot(self.t, self.y, c='black', alpha=0.9)
